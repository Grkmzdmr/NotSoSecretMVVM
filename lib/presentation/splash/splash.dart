    ...
    return Scaffold(
        ...
        body: ElasticIn(
          ...
          child: Center(
            ...
            Expanded(
              flex: 3,
              child: Text("Snow Sparrow",style: Theme.of(context).textTheme.headline1?.copyWith(color: ColorManager.white,fontSize: FontSize.s20,wordSpacing: AppSize.s6,letterSpacing: AppSize.s1),)),
            Spacer(flex: 2,),
                ]
            ),
          ),
